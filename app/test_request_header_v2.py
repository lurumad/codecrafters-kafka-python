...
class TestRequestV2(unittest.TestCase):
    def test_request_header_v2_with_client_id_to_bytes(self):
        ...
        self.assertEqual(b"\x00\x12\x00\x04o\x7f\xc6a\x00\x07client1", data)
    ...
    def test_request_header_v2_without_client_id_to_bytes(self):
        ...
        self.assertEqual(b"\x00\x12\x00\x04o\x7f\xc6a\xff\xff", data)
    ...
    def test_request_header_v2_with_client_id_from_bytes(self):
        ...
        response = RequestHeaderV2.from_bytes(b"\x00\x12\x00\x04o\x7f\xc6a\x00\x07client1")
    ...
    def test_request_header_v2_without_client_id_from_bytes(self):
        ...
        response = RequestHeaderV2.from_bytes(b"\x00\x12\x00\x04o\x7f\xc6a\xff\xff")
